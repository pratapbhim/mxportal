...
export const MXSidebarWhite: React.FC<MXSidebarWhiteProps> = ({
  ...
  const handleLogout = async () => {
    ...
    try {
      // Clear localStorage if using client-side auth
  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-50 p-2 rounded-lg bg-white text-gray-900 hover:bg-gray-100 border border-gray-200"
      >
        <Menu size={24} />
      </button>
